        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 order-2 lg:order-1">
            <div className="sticky top-8 space-y-6">
              <Button asChild variant="outline" className="w-full border-[#1e90ff] text-[#1e90ff]">
                <Link href="/blog">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <nav className="space-y-2 text-sm">
                  <a href="#wordpress" className="block text-gray-600 hover:text-[#1e90ff]">
                    WordPress: O CMS Mais Popular
                  </a>
                  <a href="#customizado" className="block text-gray-600 hover:text-[#1e90ff]">
                    Sites Customizados
                  </a>
                  <a href="#quando-wordpress" className="block text-gray-600 hover:text-[#1e90ff]">
                    Quando Escolher WordPress
                  </a>
                  <a href="#quando-customizado" className="block text-gray-600 hover:text-[#1e90ff]">
                    Quando Escolher Customizado
                  </a>
                  <a href="#custos" className="block text-gray-600 hover:text-[#1e90ff]">
              ...
              <div className="bg-[#1e90ff] rounded-lg p-6 text-white">
                ...
                <p className="text-sm text-white/90 mb-4">
                  Nossa equipe pode ajudar você a escolher a melhor solução para seu projeto.
                </p>
                <Button asChild className="w-full bg-white text-[#1e90ff] hover:bg-gray-100">
            ...
            <article>
              ...
              <div className="mt-12 p-6 bg-gray-50 rounded-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-[#022041] mb-2">Equipe VierCa</h4>
                    <p className="text-gray-600 text-sm">
                      Nossa equipe de especialistas em desenvolvimento web está sempre criando conteúdo útil para ajudar
                      empresas a tomar as melhores decisões tecnológicas.
                    </p>
                  </div>
                </div>
              </div>
